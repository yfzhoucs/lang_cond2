...
def main(writer, name, batch_size=128):
    ...
    data_dirs_test = [
        os.path.join(data_root_path, 'dataset/mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_test/'),
    ]
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-pressure-test-2'
