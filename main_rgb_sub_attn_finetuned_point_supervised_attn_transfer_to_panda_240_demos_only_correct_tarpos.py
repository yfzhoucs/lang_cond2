...
def main(writer, name, batch_size=256):
    ...
    dataset_train = DMPDatasetEERandTarXYLang(data_dirs, random=False, length_total=120, normalize='panda')
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-point-supervised-attn-transfer-to-panda-load-visual-240-demos-only-correct-tarpos'
