...
from utils.load_data_rgb_all_delta_action_fast_gripper_finetuned_attn import DMPDatasetEERandTarXYLang, pad_collate_xy_lang
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-finetuned-attn'
