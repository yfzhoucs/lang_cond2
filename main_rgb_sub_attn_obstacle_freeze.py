...
from models.backbone_rgbd_sub_attn_obstacle_freeze import Backbone
...
def main(writer, name, batch_size=96):
    ...
    # Only unfreeze the needed part: obstacle token, obstacle token embeding, embed_to_obstacle_pos, controller
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-obstacle-100-part-not-in-the-way-freeze'
