...
def main(writer, name, batch_size=256):
    ...
    ckpt = os.path.join(ckpt_path, 'train-12-rgb-sub-attn-fast-gripper-abs-action-point-supervised-attn-transfer-to-panda-load-visual/100000.pth')
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-point-supervised-attn-transfer-to-panda-load-visual-cont'
