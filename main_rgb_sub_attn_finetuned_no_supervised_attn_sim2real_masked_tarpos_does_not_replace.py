...
from utils.load_data_rgb_abs_action_fast_gripper_finetuned_attn_sim2real_load_preprocessed_masked_tarpos_does_not_replace import DMPDatasetEERandTarXYLang, pad_collate_xy_lang
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-no-supervised-attn-sim2real-masked_tarpos-does-not-replace'
