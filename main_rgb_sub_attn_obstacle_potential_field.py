...
def main(writer, name, batch_size=96):
    ...
    # load data
    data_dirs = [
        os.path.join(data_root_path, 'mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_obstacle_mini/'),
        os.path.join(data_root_path, 'mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_obstacle_not_in_the_way/'),
    ]
    data_dirs_test = [
