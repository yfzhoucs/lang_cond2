...
class Backbone(nn.Module):
    ...
    def forward(self, img, joints, sentence, phis, stage=0):
        ...
        obstacle_pos_pred = self.embed_to_obstacle_pos(state_embedding3[:, 5, :])
        if stage == 1:
            return target_position_pred, ee_pos_pred, displacement_pred, obstacle_pos_pred, attn_map, attn_map2, attn_map3
        ...
        return target_position_pred, ee_pos_pred, displacement_pred, obstacle_pos_pred, attn_map, attn_map2, attn_map3, attn_map4, trajectory
