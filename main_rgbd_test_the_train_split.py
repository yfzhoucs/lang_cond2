...
def main(writer, name, batch_size=96):
    ...
    ckpt = None
    ckpt = '/share/yzhou298/ckpts/train-11-rgbd-mse/135000.pth'

    # load model
    model = Backbone(img_size=224, embedding_size=192, num_traces_in=9, num_traces_out=10, num_weight_points=36)
    if ckpt is not None:
