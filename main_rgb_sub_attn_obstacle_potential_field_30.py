...
def main(writer, name, batch_size=96):
    ...
    # load data
    data_dirs = [
        os.path.join(data_root_path, 'mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_obstacle_30/'),
        os.path.join(data_root_path, 'mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_obstacle_not_in_the_way_30/'),
    ]
    data_dirs_test = [
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-obstacle-30-part-not-in-the-way-potential'
