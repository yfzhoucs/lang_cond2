...
def main(writer, name, batch_size=256):
    ...
    pretrained_dict = torch.load(os.path.join(ckpt_path, 'train-12-rgb-sub-attn-fast-gripper-abs-action-range-supervised-attn/330000.pth'))['model']
    ...
    # load data
    data_dirs = [
        '/mnt/disk2/dataset/data_real_matched_q_grid/',
        '/mnt/disk2/dataset/data_real_matched_q/',
        '/mnt/disk2/dataset/data_real_unmatched_q/',
    ]
    data_dirs_val = [
        '/mnt/disk2/dataset/data_real_matched_q_grid_2/',
    ]
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-barebone-sim2real-masked_tarpos'
