...
def main(writer, name, batch_size=256):
    ...
    pretrained_dict = torch.load(os.path.join(ckpt_path, 'train-12-rgb-sub-attn-fast-gripper-abs-action-jaco2-no-sup-attn/160000.pth'))['model']
    ...
    dataset_test = DMPDatasetEERandTarXYLang([os.path.join(data_root_path, 'dataset/mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_test_4/')], random=True, length_total=120, normalize='separate')
...
if __name__ == '__main__':
    name = 'train-12-rgb-sub-attn-fast-gripper-abs-action-no-supervised-attn-jaco2-to-ur5-320-demos'
