...
def main(writer, name, batch_size=96):
    ...
    # load data
    data_dirs = [
        '/data/Documents/yzhou298/dataset/tiny_ur5_train/',
        '/data/Documents/yzhou298/dataset/collected7_random_init_angles'
    ]
    data_dirs_val = [
...
if __name__ == '__main__':
    name = 'train-tinyur5-rgb-sub-attn-range-larger-dataset'
